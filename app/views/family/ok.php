...
<div class="container main" style="height: 500px">
    <h1>Поздравляем! Ваш пакет успешно активирован.</h1><br>
    <p style="color: #fcfcfc; font-size: large; font-weight: bold">Теперь вы можете вернуться в ваш личный кабинет и приступить к чтению книги</p><br>

    <form action="ok" method="post" class='btn_program'>
        <input type="hidden" name="exit_btn">

            <input type="hidden" name="time" value="<?=date('Y-m-d h:m:s', strtotime('+30 Days'))?>">

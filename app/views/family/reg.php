...
<div class="container main">
    ...
    <form action="/family/reg" method="post" class="form-control">
...
<!--            <input type="text" name="link" placeholder="none" value="--><?//=$_POST['link']?><!--">-->
<!--        --><?php //else: ?>
<!--            <input type="text" name="link" placeholder="none">-->
<!--        --><?php //endif; ?>

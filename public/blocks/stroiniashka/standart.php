...
<div class="consult" style="color: #eaeaea">
    <h1>Программа снижения веса "Стандарт"</h1><br>
    ...
    <a href="/hudeem/menu" style="margin-top: 10px">
        <button class="btn_why mobile" style="float: left; height: auto; margin-bottom: 20px; font-size: medium; font-weight: bold">Меню на 10 дней</button>
    </a>
